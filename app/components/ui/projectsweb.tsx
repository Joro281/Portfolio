...
const projects = [
  {
    ...
    year: 2026,
    command: "git clone luxury-presence",
    description:
      "A premium real estate landing page revamp focusing on elegance, responsiveness, and user experience. Created as a comprehensive web builder assignment.",
    image: "/images/luxurypresence/luxurypresence.jpg",
    tags: ["Web Design", "Real Estate", "Frontend", "UI/UX"],
    caseStudy: "luxurypresence-case-study",
  },
  {
    title: "SiteBuilt",
    year: 2026,
    command: "git clone sitebuilt",
    description:
      "Intelligent construction-documentation platform that transforms site photos into photo-verified As-Built drawings automatically using computer vision and geolocation.",
    image: "/images/sitebuilt/sitebuilt.jpg",
    tags: ["Computer Vision", "Geolocation", "Construction Tech", "Automation", "React"],
    caseStudy: "sitebuilt-case-study",
  },
  {
    title: "Mase",
    year: 2025,
    command: "git clone mase",
    description:
      "Hospital Management System designed to streamline operations by automating scheduling, patient data, and staff monitoring. Features HIPAA-compliant OpenAI integration for document analysis.",
    image: "/images/mase/mase.jpg",
    tags: ["Supabase", "OpenAI", "React", "Next.js", "Healthcare", "HIPAA"],
    caseStudy: "mase-case-study",
  },
  {
    title: "Bengals",
    year: 2025,
    command: "git clone bengals",
    description:
      "Developed a modern website for a premium seafood delivery business, showcasing their fresh catches from General Santos City to Cagayan de Oro with online ordering capabilities.",
    image: "/images/bengals/bengals_hero.png",
    tags: ["Next.js", "Tailwind CSS", "React", "Responsive Design", "E-commerce", "Web Development"],
    caseStudy: "bengals-case-study",
  },
  {
    title: "MindBloom",
    year: 2025,
    command: "git clone mindbloom",
    description:
      "Developed a comprehensive mental health and wellness platform featuring mood tracking, meditation guides, journaling capabilities, and professional resources for mental health support.",
    image: "/images/mindbloom/mindbloom_hero.png",
    tags: ["Next.js", "Tailwind CSS", "React", "Responsive Design", "Web Development"],
    caseStudy: "mindbloom-case-study",
  },
  {
    title: "Portfolio",
    year: 2025,
  ...
  },
  {
    ...
    image: "/images/aquaculture/Thesis.jpg",
  ...
  },
  {
    ...
    image: "/images/fuelrequest/Fuel_Request.jpg",
  ...
  },
  {
    ...
    image: "/images/robocar/Robocar.jpg",
  ...
  },
  {
    ...
    image: "/images/birddetection/birddetection_hero.jpg",
  ...
  },
  {
    ...
    image: "/images/click2permit/click2permit_landingpage.jpg",
